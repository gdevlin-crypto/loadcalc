...
Enter the project address and any permit numbers you have. Pick the correct **Jurisdiction** — Vancouver, City of North Vancouver, District of North Vancouver, West Vancouver, or Burnaby. This is the AHJ form you'll fill at the end, so picking the wrong one wastes time later.
...
The calc involves more than three dwellings (the tool currently supports up to three).
